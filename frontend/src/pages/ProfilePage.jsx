...
const ProfilePage = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            {/* Profile Header */}
            <div className="bg-white shadow-lg rounded-lg overflow-hidden mb-8 relative"> {/* Added relative positioning for button */}
                ...
                <div className="px-8 py-6">
                    ...
                    {userInfo?._id === profile._id && ( // Only show edit button to the profile owner
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-edit-3"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg>
                            Edit Profile
                        </button>
                    )}
