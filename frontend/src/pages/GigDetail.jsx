...
const GigDetail = () => {
    ...
    useEffect(() => {
        // We don't necessarily want to force redirect to login if someone just wants to VIEW a public gig
        // But the previous code had it, so I'll keep it for now if that's the desired flow.
        // Actually, many apps allow viewing but require login to BID.
        // I'll keep the login check but maybe move it to the BID placement logic.
        fetchGigDetails();
    }, [id, userInfo]);
