...
import { Search, IndianRupee, ArrowRight, Filter, X, Star, Loader2 } from 'lucide-react';
...
const GigsFeed = () => {
    ...
    const {
        ...
        queryKey: ['gigs', searchQuery, selectedCategory, selectedTags],
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
            ...
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
                <div className="space-y-1">
                    <h1 className="text-4xl font-extrabold text-gray-900 dark:text-white">Discover Internships</h1>
                    <p className="text-gray-500 dark:text-gray-400">Explore the best opportunities from top-tier hirers.</p>
                </div>
            ...
            {status === 'loading' ? (
                ...
                <div className="text-center py-20 bg-red-50 dark:bg-red-900/10 rounded-3xl border border-red-100 dark:border-red-900/30">
                    <p className="text-red-600 dark:text-red-400 font-bold">Error loading gigs: {error.message}</p>
                ...
                <div className="text-center py-32 bg-gray-50/50 dark:bg-gray-800/25 rounded-3xl border-2 border-dashed border-gray-200 dark:border-gray-800">
                    <div className="max-w-xs mx-auto">
                        ...
                        <p className="text-gray-500 dark:text-gray-400">We couldn't find any opportunities matching your current filters.</p>
                        <button 
                            onClick={resetFilters}
            ...
            {hasNextPage && (
                <div className="flex justify-center pt-12">
                    <button 
                        ...
                        className="px-8 py-3 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl font-bold shadow-sm hover:shadow-lg transition-all flex items-center gap-3 dark:text-white"
                    >
                        {isFetchingNextPage ? (
                            <>
